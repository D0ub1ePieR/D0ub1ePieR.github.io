...
<div class="profile-section">
  ...
  <div class="profile-info">
    ...
    <div class="social-links">
      ...
      <a href="{{ '/assets/files/cv.pdf' | relative_url }}" target="_blank" aria-label="CV" class="cv-link"><i class="fas fa-file-pdf icon-cv"></i> <small>简历下载</small></a>
    </div>
  </div>
</div>
...
<section class="section">
  ...
  <p style="color: var(--text-light); margin-bottom: 1rem;">
    {{ d.publications.subtitle }} <a href="{{ d.publications.pub_url | default: '/publications' | relative_url }}">{{ d.publications.subtitle_link }}</a>
  </p>
